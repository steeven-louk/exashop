...
export const CartDetail = () => {
  ...
  <tbody>
    ...
    <td><img src={men1} alt="" width={65} className="rounded object-fit-cover" /></td>
      <td>Classic Spring</td>
      <td>$120.00</td>
      <td className="d-flex gap-2"><span className="px-2 fw-bold bg-danger rounded-pill">-</span> <div className="bg-white px-3">5</div> <span className="px-2 fw-bold bg-danger rounded-pill">+</span></td>
      <td>white</td>
    </tr>
    <tr className="my-auto align-baseline">
    <td><img src={men1} alt="" width={65} className="rounded object-fit-cover" /></td>
      ...
      <td>white</td>
            ...
            <div className="col-md-5 bg-white rounded p-2 shadow">
                ...
                <button className="btn-success btn d-block mx-auto text-capitalize">proceed to checkout</button>
            </div>
        </div>
    </div>
  )
